...
export class LagerService {
    ...
    async getArtiklesForKommiss(){
       ...
       artikel.name, artikel.verPrice2, artikel.verPrice, artikel.minLosMenge, artikel.gewicht, artikel.basisEinheit, artikel.ARTIKELFLAGE, artikel.liferantId FROM lagerplatz
